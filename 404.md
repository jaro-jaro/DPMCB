...
<script>
    ...
    if (window.location.pathname.startsWith("/DPMCB/spoj/S-325")) {
        ...
        p3.innerHTML = `Pokud máte aplikaci a přesto se neotevřela automaticky (po kliknutí výše se ale otevře), musíte povolit otevírání odkazů v <a href="intent://#Intent;scheme=package;action=APPLICATION_DETAILS_SETTINGS;end">nastavení aplikace</a>`
    }
