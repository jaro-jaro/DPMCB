 ...
 *
 * @property dest Cílová stanice – Shodná s [ZastavkaSpoje.name] poslední ze stanic [DetailSpoje.stations]
 ...
 * @property time Čas odjezdu z této zastávky – Shodné s [ZastavkaSpoje.departureTime] u stanice z [DetailSpoje.stations] s odpovídajícím [ZastavkaSpoje.id]
