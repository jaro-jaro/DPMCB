...
//                                    .verticalScroll(rememberScrollState())
                ...
                Column(
                    ...
                    if (state !is SpojState.OK.Online && state.chyba) Card(
                        ...
                        Text(text = "Pravděpodobně spoj neodesílá data o své poloze, nebo má zpoždění a ještě nevyjel ze své výchozí zastávky. Často se také stává, že je spoooj přibližně první tři minuty své jízdy offline a až poté začne odesílat aktuální data", Modifier.padding(all = 8.dp))
                    }
                    OutlinedCard(
                        modifier = Modifier
                            .fillMaxWidth()
